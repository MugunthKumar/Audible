...
def mypy(session: Session) -> None:
    ...
    session.install(".")
    session.install("mypy", "pytest", "pytest-httpx", "pytest-mock")
...
def tests(session: Session) -> None:
    ...
    session.install(".")
    session.install(
        "coverage[toml]", "pytest", "pytest-httpx", "pytest-mock", "pygments"
    )
    try:
...
def typeguard(session: Session) -> None:
    ...
    session.install(".")
    session.install("pytest", "pytest-httpx", "pytest-mock", "typeguard", "pygments")
